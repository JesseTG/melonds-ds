...
const struct retro_input_descriptor MelonDsDs::input_descriptors[] = {
        ...
        {0, RETRO_DEVICE_JOYPAD, 0,                               RETRO_DEVICE_ID_JOYPAD_Y,      "Y / Microphone"},
        {0, RETRO_DEVICE_JOYPAD, 0,                               RETRO_DEVICE_ID_JOYPAD_L2,     "Speedup Pointer+Enable Alternate Controls"},
