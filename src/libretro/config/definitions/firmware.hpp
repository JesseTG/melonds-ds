...
namespace MelonDsDs::config::definitions {
    ...
    constexpr retro_core_option_v2_definition Language {
    ...
    constexpr retro_core_option_v2_definition Username {
    ...
    constexpr retro_core_option_v2_definition FavoriteColor {
    ...
    constexpr retro_core_option_v2_definition BirthMonth {
    ...
    constexpr retro_core_option_v2_definition BirthDay {
    ...
    constexpr retro_core_option_v2_definition EnableAlarm {
    ...
    constexpr retro_core_option_v2_definition AlarmHour {
    ...
    constexpr retro_core_option_v2_definition AlarmMinute {
